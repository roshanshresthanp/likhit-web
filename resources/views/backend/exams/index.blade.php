      ...
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="row col-sm-6 d-flex justify-content-between">
            ...
            <a href="{{ route('exams.index') }}"> <span class="fa fa-arrow-left mr-2"></span> BACK</a>
          </button>
          ...
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-light">
              <div class="inner">
                ...
                <h4 class="p-4">{{ $exam->title }}</h4>

              </div>
              <div class="icon">
                <i class="fas"><a href="{{route('exam.subject',$exam->id)}}"><img src="{{ Storage::url($exam->featured_img) }}" onerror="this.src='{{Storage::url('uploads/noimage.jpg')}}';" height="80px" width="85px">
               </a> </i>
              </div>
