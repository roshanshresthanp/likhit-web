...
class SubjectController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try{
            Exam::create($data);
            return redirect()->route('subjects.index')->with('success','Exam type has been added successfully');
        }catch(\Exception $e){
    ...
    public function edit($id)
    {
        ...
        return view('backend.subjects.form',compact('exam'));
    ...
    public function update(Request $request, $id)
    {
        ...
        try{
            ...
            return redirect()->route('subjects.index')->with('success','Exam type has been updated successfully');
        }catch(\Exception $e){
            // Session::flash('message', 'This is a message!');
            return redirect()->back()->with(['error'=>$e]);
        }
